...
<br>
<div>
<div class=" benefits" style="padding:10px;">
					<h4>Login To Post Free Ads On pingee</h4>
					<h4>Don't Have An Account? </h4>
					<a href="ad_sign_up.php"><button class="btn btn-warning" style=" box-shadow: 10px 10px 5px grey; padding-top:15px; padding-bottom:15px; padding-left:35px; padding-right:35px; color:#FFFFFF; background:#FF9900">Sign up</button></a>
				</div>
...
<div class="row"  style="background: #f2f2f2;">
   ...
   <div class="login-signup-form">
				<div class=" nl_border text-center" style="background: #FFFFFF;">
					...
					<h5>OR</h5>
					<form id="login_form_HR0" action="login_process_to_post_ad.php" method="post">
